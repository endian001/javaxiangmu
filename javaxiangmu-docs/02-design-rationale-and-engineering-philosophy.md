...
> **以单体架构承接完整运营闭环；以兼容策略保护旧客户端；在高风险链路上逐步引入服务化、显式状态和审计；在后台运营侧用契约化方式换取页面交付速度。**
...
- 活动服务负责活动可见性和弹窗选择。
- TCG 业务运营服务负责活动黑名单、活动券、游戏限制和玩家限额。
...
大量 TCG 数字 code、菜单别名、shell 页面、平台运营、游戏管理、推广渠道、KYC 和业务运营表，说明近期需求可能是对标某个成熟后台产品或迁移到一套新的运营后台语义。
