...
前台品牌以 **TH2.VIP** 呈现，业务系统内部也使用 **TH2W** 命名。产品面向玩家、代理和后台运营人员三类主要角色，同时还与第三方游戏厂商、支付渠道、Stream Chat、推广渠道和 TCG 风格运营后台能力对接。
...
如果外部客服链接、实时客服、Stream Chat 和工单开关都未配置，则客服 payload 会返回未配置状态。前端仍有默认工单页面 fallback。
